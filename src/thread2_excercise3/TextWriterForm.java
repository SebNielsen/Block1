...
public class TextWriterForm extends javax.swing.JFrame {
  ...
  private BackUpHandler backUp = new BackUpHandler(lines);
  private int count = 0;
  ...
  private void btnNewLineActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNewLineActionPerformed
    addLine();
    if(count == 0){
        BackUpHandler b = new BackUpHandler(lines);
        b.registerObserver(new Observer() {
            @Override
            public void dataSaved(String str) {
                jLabel1.setText(str);
            }
        });
        count = 1;
